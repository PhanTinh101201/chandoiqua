...
export default function success({}: Props) {
  return (
    <div className="w-full flex-1 bg-white flex form-sndl-css justify-center items-center">
      <div className="w-[350px] -mt-[8%]">
        ...
        <div className="flex flex-col">
          <Link href="/login">
            <a className="bg-[#FF858B] flex justify-center items-center font-[14px] font-[500] leading-[1.5] h-[50px] text-white rounded-[6px] cursor-pointer">
              ログインへ戻る
            </a>
          </Link>
        </div>
